...
public enum DataBoxType {
    ...
    OVM_FO("OVM_FO", 14), //Fyzická osoba, která je v roli OVM
    OVM_PFO("OVM_PFO", 15), //Podnikající fyzická osoba, která je v roli OVM
    OVM_PO("OVM_PO", 16), //Právnická osoba v roli OVM
    ...
    PFO_AUDITOR("PFO_AUDITOR", 34), //Podnikající fyzická osoba - statutární auditor (OSVČ nebo zaměstnanec¨)
